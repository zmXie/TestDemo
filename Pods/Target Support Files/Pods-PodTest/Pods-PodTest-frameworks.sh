...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PaperManagement_Category/PaperManagement_Category.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZMSafe/ZMSafe.framework"
fi
